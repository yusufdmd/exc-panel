...
| `js/engagement.js` | "🏆 Katılım Yarışması" — SVS/SS/KoD/GVG katılımını dönemsel bir puana çeviren ayrı sıralama; admin dönemi kapattığında sonuç kalıcı olarak dondurulup arşivlenir, geçmiş dönemler her zaman görüntülenebilir |
