...
const DICT = {
  tr: { appName:'EXC Paneli', tagline:'Üye · Rütbe · Güç & Kamp Seviyesi · Etkinlik Takibi', refresh:'Yenile', backToSite:'← Ana Siteye Dön',
    ...
    thAppliedSlots:'Başvurduğu Saatler', thSelectedSlot:'Seçildiği Saat', thAttendStatus:'Katılım Durumu', ssSlot1:'1. Saat', ssSlot2:'2. Saat', ssSlot3:'3. Saat', ssExcusedStatus:'Mazeretli', ssAppliedNotSelected:'Başvurdu', ssAppliedSectionTitle:'Başvurular (Saat Dilimine Göre)',
  ...
  en: { appName:'EXC Panel', tagline:'Members · Rank · Power & Camp Level · Event Tracking', refresh:'Refresh', backToSite:'← Back to Site',
    ...
    thAppliedSlots:'Applied Slots', thSelectedSlot:'Selected Slot', thAttendStatus:'Attendance', ssSlot1:'Slot 1', ssSlot2:'Slot 2', ssSlot3:'Slot 3', ssExcusedStatus:'Excused', ssAppliedNotSelected:'Applied', ssAppliedSectionTitle:'Applications (by Time Slot)',
  ...
  de: { appName:'EXC Panel', tagline:'Mitglieder · Rang · Machtstufe & Basisstufe · Event-Tracking', refresh:'Aktualisieren', backToSite:'← Zur Website',
    ...
    thAppliedSlots:'Beworbene Zeiten', thSelectedSlot:'Gewählte Zeit', thAttendStatus:'Teilnahmestatus', ssSlot1:'Zeit 1', ssSlot2:'Zeit 2', ssSlot3:'Zeit 3', ssExcusedStatus:'Entschuldigt', ssAppliedNotSelected:'Beworben', ssAppliedSectionTitle:'Bewerbungen (nach Zeitfenster)',
  ...
  es: { appName:'Panel EXC', tagline:'Miembros · Rango · Poder y Nivel de Campamento · Seguimiento de Eventos', refresh:'Actualizar', backToSite:'← Volver al Sitio',
    ...
    thAppliedSlots:'Horarios Solicitados', thSelectedSlot:'Horario Seleccionado', thAttendStatus:'Estado de Asistencia', ssSlot1:'Horario 1', ssSlot2:'Horario 2', ssSlot3:'Horario 3', ssExcusedStatus:'Justificado', ssAppliedNotSelected:'Solicitó', ssAppliedSectionTitle:'Solicitudes (por Horario)',
  ...
  fr: { appName:'Panneau EXC', tagline:'Membres · Rang · Puissance et Niveau de Camp · Suivi des Événements', refresh:'Actualiser', backToSite:'← Retour au Site',
    ...
    thAppliedSlots:'Créneaux Demandés', thSelectedSlot:'Créneau Sélectionné', thAttendStatus:'Statut de Présence', ssSlot1:'Créneau 1', ssSlot2:'Créneau 2', ssSlot3:'Créneau 3', ssExcusedStatus:'Excusé', ssAppliedNotSelected:'A postulé', ssAppliedSectionTitle:'Candidatures (par Créneau)',
  ...
  vi: { appName:'EXC Panel', tagline:'Thành viên · Cấp bậc · Sức mạnh & Cấp độ Trại · Theo dõi Sự kiện', refresh:'Làm mới', backToSite:'← Về Trang chủ',
    ...
    thAppliedSlots:'Khung giờ Đã Đăng ký', thSelectedSlot:'Khung giờ Được Chọn', thAttendStatus:'Trạng thái Tham gia', ssSlot1:'Khung 1', ssSlot2:'Khung 2', ssSlot3:'Khung 3', ssExcusedStatus:'Được miễn', ssAppliedNotSelected:'Đã đăng ký', ssAppliedSectionTitle:'Đăng ký (theo Khung giờ)',
