...
const DICT = {
  tr: { appName:'EXC Paneli', tagline:'Üye · Rütbe · Güç & Kamp Seviyesi · Etkinlik Takibi', refresh:'Yenile', backToSite:'← Ana Siteye Dön',
    ...
    ebTier100:'100% Katılım', ebTier85:'85%+ Katılım', ebTier70:'70%+ Katılım', ebTier55:'55%+ Katılım', ebTier40:'40%+ Katılım', ebTierLow:'<40% Katılım', ebFootnote:'%50\'nin altındaysan daha çok etkinliğe katılmayı düşün!',
  ...
  en: { appName:'EXC Panel', tagline:'Members · Rank · Power & Camp Level · Event Tracking', refresh:'Refresh', backToSite:'← Back to Site',
    ...
    ebTier100:'100% Participation', ebTier85:'85%+ Participation', ebTier70:'70%+ Participation', ebTier55:'55%+ Participation', ebTier40:'40%+ Participation', ebTierLow:'<40% Participation', ebFootnote:'If you\'re under 50%, consider joining more events!',
  ...
  de: { appName:'EXC Panel', tagline:'Mitglieder · Rang · Machtstufe & Basisstufe · Event-Tracking', refresh:'Aktualisieren', backToSite:'← Zur Website',
    ...
    ebTier100:'100% Teilnahme', ebTier85:'85%+ Teilnahme', ebTier70:'70%+ Teilnahme', ebTier55:'55%+ Teilnahme', ebTier40:'40%+ Teilnahme', ebTierLow:'<40% Teilnahme', ebFootnote:'Bist du unter 50%, nimm an mehr Events teil!',
  ...
  es: { appName:'Panel EXC', tagline:'Miembros · Rango · Poder y Nivel de Campamento · Seguimiento de Eventos', refresh:'Actualizar', backToSite:'← Volver al Sitio',
    ...
    ebTier100:'100% Participación', ebTier85:'85%+ Participación', ebTier70:'70%+ Participación', ebTier55:'55%+ Participación', ebTier40:'40%+ Participación', ebTierLow:'<40% Participación', ebFootnote:'¡Si estás por debajo del 50%, considera participar en más eventos!',
  ...
  fr: { appName:'Panneau EXC', tagline:'Membres · Rang · Puissance et Niveau de Camp · Suivi des Événements', refresh:'Actualiser', backToSite:'← Retour au Site',
    ...
    ebTier100:'100% Participation', ebTier85:'85%+ Participation', ebTier70:'70%+ Participation', ebTier55:'55%+ Participation', ebTier40:'40%+ Participation', ebTierLow:'<40% Participation', ebFootnote:"Si tu es en dessous de 50%, pense à participer à plus d'événements !",
  ...
  vi: { appName:'EXC Panel', tagline:'Thành viên · Cấp bậc · Sức mạnh & Cấp độ Trại · Theo dõi Sự kiện', refresh:'Làm mới', backToSite:'← Về Trang chủ',
    ...
    ebTier100:'100% Tham gia', ebTier85:'85%+ Tham gia', ebTier70:'70%+ Tham gia', ebTier55:'55%+ Tham gia', ebTier40:'40%+ Tham gia', ebTierLow:'<40% Tham gia', ebFootnote:'Nếu bạn dưới 50%, hãy tham gia nhiều sự kiện hơn nhé!',
