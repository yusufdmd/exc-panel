...
const DICT = {
  ...
  en: { appName:'EXC Panel', tagline:'Members · Rank · Power & Camp Level · Event Tracking', refresh:'Refresh', backToSite:'← Back to Site',
    ...
    subEngagement:'🏆 Engagement Challenge', startEngagementPeriod:'🔄 Start New Period', engagementPeriodLabel:'Period: since {date}', thEngagementTotal:'Total', emptyEngagementTitle:'No data yet for this period', emptyEngagementDesc:'This will show up once the first week is added after the period starts.', confirmStartNewEngagementPeriod:'Start a new period? Ranking will count from today onward (past data is not deleted).', toastEngagementPeriodStarted:'New period started.',
