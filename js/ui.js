...
export const state = {
  ...
  boardSortDir: -1,
  boardSearch: "",
  engagementPeriodStart: null, // "YYYY-MM-DD" — "Katılım Yarışması" dönem başlangıcı, admin "Yeni Dönem Başlat" ile değiştirir (bkz. engagement.js)
...
const DICT = {
  ...
  es: { appName:'Panel EXC', tagline:'Miembros · Rango · Poder y Nivel de Campamento · Seguimiento de Eventos', refresh:'Actualizar', backToSite:'← Volver al Sitio',
    ...
    subEngagement:'🏆 Desafío de Participación', startEngagementPeriod:'🔄 Iniciar Nuevo Período', engagementPeriodLabel:'Período: desde {date}', thEngagementTotal:'Total', emptyEngagementTitle:'Aún no hay datos para este período', emptyEngagementDesc:'Aparecerá cuando se añada la primera semana tras iniciar el período.', confirmStartNewEngagementPeriod:'¿Iniciar un nuevo período? La clasificación contará desde {date} (los datos anteriores no se eliminan).', toastEngagementPeriodStarted:'Nuevo período iniciado.',
  ...
  fr: { appName:'Panneau EXC', tagline:'Membres · Rang · Puissance et Niveau de Camp · Suivi des Événements', refresh:'Actualiser', backToSite:'← Retour au Site',
    ...
    subEngagement:"🏆 Défi d'Engagement", startEngagementPeriod:'🔄 Démarrer une Nouvelle Période', engagementPeriodLabel:'Période : depuis le {date}', thEngagementTotal:'Total', emptyEngagementTitle:"Aucune donnée pour cette période pour l'instant", emptyEngagementDesc:'Apparaîtra dès que la première semaine sera ajoutée après le début de la période.', confirmStartNewEngagementPeriod:"Démarrer une nouvelle période ? Le classement comptera à partir du {date} (les données passées ne sont pas supprimées).", toastEngagementPeriodStarted:'Nouvelle période démarrée.',
