...
export const state = {
  ...
  boardSortDir: -1,
  boardSearch: "",
  engagementPeriods: [], // "Katılım Yarışması" dönem geçmişi, en yeni önce — en fazla birinin endDate'i boştur (aktif dönem) (bkz. engagement.js)
  engagementSelectedPeriodId: null, // hangi dönem görüntüleniyor — null ise aktif döneme düşer
  engagementSortKey: "total",
  engagementSortDir: -1,
  engagementBoardTiers: [70, 50, 30], // "Katılım Panosu"nun orta 3 dilim sınırı (100 ve 0 sabit) — kalıcı, Supabase "settings" tablosunda tutulur (bkz. engagement.js -> openEngagementBoardModal/saveEngagementBoardTiers)
...
const DICT = {
  tr: { appName:'EXC Paneli', tagline:'Üye · Rütbe · Güç & Kamp Seviyesi · Etkinlik Takibi', refresh:'Yenile', backToSite:'← Ana Siteye Dön',
    ...
    addWeek:'+ Hafta Ekle', weekAddTitle:'Hafta Ekle', lblWeekLabel:'Hafta Etiketi', lblWeekDate:'Tarih', weekNameRequired:'Hafta etiketi gerekli.', weekNamePrefix:'Hafta',
    ...
    subOther:'Diğer', addEvent:'+ Etkinlik Ekle', eventAddTitle:'Etkinlik Ekle', lblEventLabel:'Etkinlik Adı', eventNameRequired:'Etkinlik adı gerekli.', eventNamePrefix:'Etkinlik',
    subEngagement:'🏆 Katılım Yarışması', startEngagementPeriod:'🔄 Yeni Dönem Başlat', endEngagementPeriod:'🏁 Dönemi Bitir', confirmEndEngagementPeriod:'Dönemi {date} tarihiyle bitirmek istediğine emin misin? Sıralama kalıcı olarak dondurulur — yeni dönemi istediğin zaman ayrıca başlatabilirsin.', toastEngagementPeriodEnded:'Dönem bitirildi, sıralama donduruldu.', engagementNoActivePeriod:'Şu an aktif bir dönem yok.', deleteEngagementPeriodTitle:'Bu dönemi sil', confirmDeleteEngagementPeriod:'"{date}" dönemini kalıcı olarak silmek istediğine emin misin? Bu dönemin sıralaması/kazananı bir daha geri getirilemez.', toastEngagementPeriodDeleted:'Dönem silindi.', engagementOngoing:'devam ediyor', engagementNewPeriodMustBeAfterStart:'Yeni dönem, mevcut dönemin başlangıcından sonraki bir tarihte başlamalı.', thEngagementTotal:'Toplam', emptyEngagementTitle:'Bu dönemde henüz veri yok', emptyEngagementDesc:'Dönem başladıktan sonra ilk hafta eklendiğinde burada görünecek.', confirmStartNewEngagementPeriod:'Yeni bir dönem başlatmak istediğine emin misin? Sıralama {date} tarihinden itibaren sıfırdan sayılmaya başlar (geçmiş veri silinmez).', toastEngagementPeriodStarted:'Yeni dönem başlatıldı.',
    engagementBoardBtn:'🏆 Katılım Panosu', downloadEngagementBoard:'📥 Görsel Olarak İndir', engagementBoardFileName:'katilim-panosu',
ebParticipationWord:'Katılım', ebFootnote:'%50\'nin altındaysan daha çok etkinliğe katılmayı düşün!', ebInvalidTiers:'Dilim sınırları 1-99 arasında ve azalan sırada (ör. 70, 50, 30) olmalı.', ebTiersSaved:'Katılım panosu dilimleri kaydedildi.',
    ebSettingsBtnTitle:'Dilim sınırlarını ayarla', ebSettingsTitle:'Katılım Panosu Dilimleri', ebSettingsSubtitle:'En üst (%100) ve en alt dilim sabittir, aradaki 3 sınırı sen belirlersin.', ebSetting2Label:'2. Dilim Sınırı (%)', ebSetting3Label:'3. Dilim Sınırı (%)', ebSetting4Label:'4. Dilim Sınırı (%)',
  ...
  en: { appName:'EXC Panel', tagline:'Members · Rank · Power & Camp Level · Event Tracking', refresh:'Refresh', backToSite:'← Back to Site',
    ...
    addWeek:'+ Add Week', weekAddTitle:'Add Week', lblWeekLabel:'Week Label', lblWeekDate:'Date', weekNameRequired:'Week label is required.', weekNamePrefix:'Week',
    ...
    subOther:'Other', addEvent:'+ Add Event', eventAddTitle:'Add Event', lblEventLabel:'Event Name', eventNameRequired:'Event name is required.', eventNamePrefix:'Event',
    subEngagement:'🏆 Engagement Challenge', startEngagementPeriod:'🔄 Start New Period', endEngagementPeriod:'🏁 End Period', confirmEndEngagementPeriod:'End the period as of {date}? Ranking will be permanently frozen — you can start a new period separately whenever you\'re ready.', toastEngagementPeriodEnded:'Period ended, ranking frozen.', engagementNoActivePeriod:'There is no active period right now.', deleteEngagementPeriodTitle:'Delete this period', confirmDeleteEngagementPeriod:'Permanently delete the period "{date}"? Its ranking/winner cannot be recovered.', toastEngagementPeriodDeleted:'Period deleted.', engagementOngoing:'ongoing', engagementNewPeriodMustBeAfterStart:"The new period must start after the current period's start date.", thEngagementTotal:'Total', emptyEngagementTitle:'No data yet for this period', emptyEngagementDesc:'This will show up once the first week is added after the period starts.', confirmStartNewEngagementPeriod:'Start a new period? Ranking will count from {date} onward (past data is not deleted).', toastEngagementPeriodStarted:'New period started.',
    engagementBoardBtn:'🏆 Participation Board', downloadEngagementBoard:'📥 Download as Image', engagementBoardFileName:'participation-board',
ebParticipationWord:'Participation', ebFootnote:'If you\'re under 50%, consider joining more events!', ebInvalidTiers:'Tier boundaries must be between 1-99 and descending (e.g. 70, 50, 30).', ebTiersSaved:'Participation board tiers saved.',
    ebSettingsBtnTitle:'Adjust tier boundaries', ebSettingsTitle:'Participation Board Tiers', ebSettingsSubtitle:'The top (100%) and bottom tiers are fixed — you set the 3 boundaries in between.', ebSetting2Label:'Tier 2 Boundary (%)', ebSetting3Label:'Tier 3 Boundary (%)', ebSetting4Label:'Tier 4 Boundary (%)',
  ...
  de: { appName:'EXC Panel', tagline:'Mitglieder · Rang · Machtstufe & Basisstufe · Event-Tracking', refresh:'Aktualisieren', backToSite:'← Zur Website',
    ...
    addWeek:'+ Woche hinzufügen', weekAddTitle:'Woche hinzufügen', lblWeekLabel:'Wochenbezeichnung', lblWeekDate:'Datum', weekNameRequired:'Wochenbezeichnung erforderlich.', weekNamePrefix:'Woche',
    ...
    subOther:'Sonstige', addEvent:'+ Event hinzufügen', eventAddTitle:'Event hinzufügen', lblEventLabel:'Eventname', eventNameRequired:'Eventname erforderlich.', eventNamePrefix:'Event',
    subEngagement:'🏆 Engagement-Challenge', startEngagementPeriod:'🔄 Neue Periode starten', endEngagementPeriod:'🏁 Periode beenden', confirmEndEngagementPeriod:'Periode zum {date} beenden? Die Wertung wird dauerhaft eingefroren — eine neue Periode kannst du jederzeit separat starten.', toastEngagementPeriodEnded:'Periode beendet, Wertung eingefroren.', engagementNoActivePeriod:'Gerade läuft keine aktive Periode.', deleteEngagementPeriodTitle:'Diese Periode löschen', confirmDeleteEngagementPeriod:'Periode "{date}" dauerhaft löschen? Die Wertung/der Gewinner können nicht wiederhergestellt werden.', toastEngagementPeriodDeleted:'Periode gelöscht.', engagementOngoing:'laufend', engagementNewPeriodMustBeAfterStart:'Die neue Periode muss nach dem Startdatum der aktuellen Periode beginnen.', thEngagementTotal:'Gesamt', emptyEngagementTitle:'Noch keine Daten für diesen Zeitraum', emptyEngagementDesc:'Erscheint, sobald nach Beginn des Zeitraums die erste Woche hinzugefügt wird.', confirmStartNewEngagementPeriod:'Neue Periode starten? Die Wertung zählt ab {date} neu (bisherige Daten werden nicht gelöscht).', toastEngagementPeriodStarted:'Neue Periode gestartet.',
    engagementBoardBtn:'🏆 Teilnahme-Tafel', downloadEngagementBoard:'📥 Als Bild herunterladen', engagementBoardFileName:'teilnahme-tafel',
ebParticipationWord:'Teilnahme', ebFootnote:'Bist du unter 50%, nimm an mehr Events teil!', ebInvalidTiers:'Die Grenzen müssen zwischen 1-99 liegen und absteigend sein (z. B. 70, 50, 30).', ebTiersSaved:'Teilnahme-Tafel-Grenzen gespeichert.',
    ebSettingsBtnTitle:'Grenzen anpassen', ebSettingsTitle:'Teilnahme-Tafel-Grenzen', ebSettingsSubtitle:'Die oberste (100%) und unterste Stufe sind fest — die 3 Grenzen dazwischen legst du fest.', ebSetting2Label:'Grenze Stufe 2 (%)', ebSetting3Label:'Grenze Stufe 3 (%)', ebSetting4Label:'Grenze Stufe 4 (%)',
  ...
  es: { appName:'Panel EXC', tagline:'Miembros · Rango · Poder y Nivel de Campamento · Seguimiento de Eventos', refresh:'Actualizar', backToSite:'← Volver al Sitio',
    ...
    addWeek:'+ Añadir semana', weekAddTitle:'Añadir semana', lblWeekLabel:'Etiqueta de semana', lblWeekDate:'Fecha', weekNameRequired:'La etiqueta de semana es obligatoria.', weekNamePrefix:'Semana',
    ...
    subOther:'Otro', addEvent:'+ Añadir evento', eventAddTitle:'Añadir evento', lblEventLabel:'Nombre del evento', eventNameRequired:'El nombre del evento es obligatorio.', eventNamePrefix:'Evento',
    subEngagement:'🏆 Desafío de Participación', startEngagementPeriod:'🔄 Iniciar Nuevo Período', endEngagementPeriod:'🏁 Finalizar Período', confirmEndEngagementPeriod:'¿Finalizar el período con fecha {date}? La clasificación se congelará permanentemente — puedes iniciar un nuevo período por separado cuando quieras.', toastEngagementPeriodEnded:'Período finalizado, clasificación congelada.', engagementNoActivePeriod:'No hay ningún período activo en este momento.', deleteEngagementPeriodTitle:'Eliminar este período', confirmDeleteEngagementPeriod:'¿Eliminar permanentemente el período "{date}"? Su clasificación/ganador no se puede recuperar.', toastEngagementPeriodDeleted:'Período eliminado.', engagementOngoing:'en curso', engagementNewPeriodMustBeAfterStart:'El nuevo período debe comenzar después de la fecha de inicio del período actual.', thEngagementTotal:'Total', emptyEngagementTitle:'Aún no hay datos para este período', emptyEngagementDesc:'Aparecerá cuando se añada la primera semana tras iniciar el período.', confirmStartNewEngagementPeriod:'¿Iniciar un nuevo período? La clasificación contará desde {date} (los datos anteriores no se eliminan).', toastEngagementPeriodStarted:'Nuevo período iniciado.',
    engagementBoardBtn:'🏆 Tablero de Participación', downloadEngagementBoard:'📥 Descargar como Imagen', engagementBoardFileName:'tablero-participacion',
ebParticipationWord:'Participación', ebFootnote:'¡Si estás por debajo del 50%, considera participar en más eventos!', ebInvalidTiers:'Los límites deben estar entre 1-99 y en orden descendente (ej. 70, 50, 30).', ebTiersSaved:'Límites del tablero de participación guardados.',
    ebSettingsBtnTitle:'Ajustar límites de nivel', ebSettingsTitle:'Niveles del Tablero de Participación', ebSettingsSubtitle:'El nivel superior (100%) e inferior son fijos — tú defines los 3 límites intermedios.', ebSetting2Label:'Límite de Nivel 2 (%)', ebSetting3Label:'Límite de Nivel 3 (%)', ebSetting4Label:'Límite de Nivel 4 (%)',
    ...
    tabActivity:'Actividad', thWhen:'Fecha', thAdmin:'Admin', thAction:'Acción', thType:'Tipo', thEntity:'Miembro', entryKindLabel:'Registros', restoreActionTitle:'Restaurar', confirmRestoreMember:'¿Restaurar este miembro (y sus registros de eventos, si los hay)?', confirmRestoreWeek:'¿Restaurar esta semana (y los registros de todos los miembros para ella)?', toastMemberRestored:'Miembro restaurado.', toastWeekRestored:'Semana restaurada.', confirmRestoreGeneric:'¿Restaurar este registro?', toastGenericRestored:'Registro restaurado.', activityDetailsTitle:'Ver detalles', snapshotNoData:'No se encontraron detalles para este registro.', snapshotPowerHistory:'Historial de Poder', snapshotTeamPowerHistory:'Historial de Poder del 1er Equipo', snapshotEntryCounts:'Registros de Eventos',
  ...
  fr: { appName:'Panneau EXC', tagline:'Membres · Rang · Puissance et Niveau de Camp · Suivi des Événements', refresh:'Actualiser', backToSite:'← Retour au Site',
    ...
    addWeek:'+ Ajouter une semaine', weekAddTitle:'Ajouter une semaine', lblWeekLabel:'Libellé de la semaine', lblWeekDate:'Date', weekNameRequired:'Le libellé de la semaine est requis.', weekNamePrefix:'Semaine',
    ...
    subOther:'Autre', addEvent:'+ Ajouter un événement', eventAddTitle:'Ajouter un événement', lblEventLabel:"Nom de l'événement", eventNameRequired:"Le nom de l'événement est requis.", eventNamePrefix:'Événement',
    subEngagement:"🏆 Défi d'Engagement", startEngagementPeriod:'🔄 Démarrer une Nouvelle Période', endEngagementPeriod:'🏁 Terminer la Période', confirmEndEngagementPeriod:"Terminer la période à la date du {date} ? Le classement sera figé de façon permanente — tu pourras démarrer une nouvelle période séparément quand tu voudras.", toastEngagementPeriodEnded:'Période terminée, classement figé.', engagementNoActivePeriod:"Il n'y a aucune période active en ce moment.", deleteEngagementPeriodTitle:'Supprimer cette période', confirmDeleteEngagementPeriod:'Supprimer définitivement la période « {date} » ? Son classement/gagnant ne pourra pas être récupéré.', toastEngagementPeriodDeleted:'Période supprimée.', engagementOngoing:'en cours', engagementNewPeriodMustBeAfterStart:"La nouvelle période doit commencer après la date de début de la période actuelle.", thEngagementTotal:'Total', emptyEngagementTitle:"Aucune donnée pour cette période pour l'instant", emptyEngagementDesc:'Apparaîtra dès que la première semaine sera ajoutée après le début de la période.', confirmStartNewEngagementPeriod:"Démarrer une nouvelle période ? Le classement comptera à partir du {date} (les données passées ne sont pas supprimées).", toastEngagementPeriodStarted:'Nouvelle période démarrée.',
    engagementBoardBtn:'🏆 Tableau de Participation', downloadEngagementBoard:'📥 Télécharger en Image', engagementBoardFileName:'tableau-participation',
ebParticipationWord:'Participation', ebFootnote:"Si tu es en dessous de 50%, pense à participer à plus d'événements !", ebInvalidTiers:"Les limites doivent être entre 1-99 et décroissantes (ex. 70, 50, 30).", ebTiersSaved:'Limites du tableau de participation enregistrées.',
    ebSettingsBtnTitle:'Ajuster les limites de niveau', ebSettingsTitle:'Niveaux du Tableau de Participation', ebSettingsSubtitle:'Le niveau supérieur (100%) et inférieur sont fixes — tu définis les 3 limites intermédiaires.', ebSetting2Label:'Limite du Niveau 2 (%)', ebSetting3Label:'Limite du Niveau 3 (%)', ebSetting4Label:'Limite du Niveau 4 (%)',
  ...
  vi: { appName:'EXC Panel', tagline:'Thành viên · Cấp bậc · Sức mạnh & Cấp độ Trại · Theo dõi Sự kiện', refresh:'Làm mới', backToSite:'← Về Trang chủ',
    ...
    addWeek:'+ Thêm Tuần', weekAddTitle:'Thêm Tuần', lblWeekLabel:'Tên Tuần', lblWeekDate:'Ngày', weekNameRequired:'Tên tuần là bắt buộc.', weekNamePrefix:'Tuần',
    ...
    subOther:'Khác', addEvent:'+ Thêm Sự kiện', eventAddTitle:'Thêm Sự kiện', lblEventLabel:'Tên Sự kiện', eventNameRequired:'Tên sự kiện là bắt buộc.', eventNamePrefix:'Sự kiện',
    subEngagement:'🏆 Thử thách Tham gia', startEngagementPeriod:'🔄 Bắt đầu Kỳ mới', endEngagementPeriod:'🏁 Kết thúc Kỳ', confirmEndEngagementPeriod:'Kết thúc kỳ vào ngày {date}? Bảng xếp hạng sẽ được đóng băng vĩnh viễn — bạn có thể bắt đầu kỳ mới riêng bất cứ khi nào sẵn sàng.', toastEngagementPeriodEnded:'Đã kết thúc kỳ, bảng xếp hạng đã đóng băng.', engagementNoActivePeriod:'Hiện không có kỳ nào đang hoạt động.', deleteEngagementPeriodTitle:'Xóa kỳ này', confirmDeleteEngagementPeriod:'Xóa vĩnh viễn kỳ "{date}"? Bảng xếp hạng/người chiến thắng sẽ không thể khôi phục.', toastEngagementPeriodDeleted:'Đã xóa kỳ.', engagementOngoing:'đang diễn ra', engagementNewPeriodMustBeAfterStart:'Kỳ mới phải bắt đầu sau ngày bắt đầu của kỳ hiện tại.', thEngagementTotal:'Tổng', emptyEngagementTitle:'Chưa có dữ liệu cho kỳ này', emptyEngagementDesc:'Sẽ hiển thị khi tuần đầu tiên được thêm sau khi kỳ bắt đầu.', confirmStartNewEngagementPeriod:'Bắt đầu kỳ mới? Bảng xếp hạng sẽ tính từ {date} (dữ liệu cũ không bị xóa).', toastEngagementPeriodStarted:'Đã bắt đầu kỳ mới.',
    engagementBoardBtn:'🏆 Bảng Tham gia', downloadEngagementBoard:'📥 Tải xuống dạng Ảnh', engagementBoardFileName:'bang-tham-gia',
ebParticipationWord:'Tham gia', ebFootnote:'Nếu bạn dưới 50%, hãy tham gia nhiều sự kiện hơn nhé!', ebInvalidTiers:'Ngưỡng phải nằm trong khoảng 1-99 và giảm dần (vd. 70, 50, 30).', ebTiersSaved:'Đã lưu ngưỡng bảng tham gia.',
    ebSettingsBtnTitle:'Điều chỉnh ngưỡng', ebSettingsTitle:'Ngưỡng Bảng Tham gia', ebSettingsSubtitle:'Mức cao nhất (100%) và thấp nhất cố định — bạn đặt 3 ngưỡng ở giữa.', ebSetting2Label:'Ngưỡng Mức 2 (%)', ebSetting3Label:'Ngưỡng Mức 3 (%)', ebSetting4Label:'Ngưỡng Mức 4 (%)',
...
export function applyStaticText() {
  ...
  document.getElementById("t_engagementBoardBtn").textContent = t("engagementBoardBtn");
  document.getElementById("t_engagementBoardTitle").textContent = t("engagementBoardBtn");
  document.getElementById("t_downloadEngagementBoard").textContent = t("downloadEngagementBoard");
  document.getElementById("t_engagementBoardSettingsBtn").title = t("ebSettingsBtnTitle");
  document.getElementById("t_engagementBoardSettingsTitle").textContent = t("ebSettingsTitle");
  document.getElementById("t_ebSettingsSubtitle").textContent = t("ebSettingsSubtitle");
  document.getElementById("t_ebSetting2Label").textContent = t("ebSetting2Label");
  document.getElementById("t_ebSetting3Label").textContent = t("ebSetting3Label");
  document.getElementById("t_ebSetting4Label").textContent = t("ebSetting4Label");
  document.getElementById("t_cancelEbSettings").textContent = t("cancel");
  document.getElementById("t_saveEbSettings").textContent = t("save");
  document.getElementById("t_close5").textContent = t("close");
  document.getElementById("t_close9").textContent = t("close");
  document.getElementById("t_closeActivityDetails").textContent = t("close");
  ...
  document.getElementById("t_subEngagement").textContent = t("subEngagement");
  document.getElementById("t_startEngagementPeriod").textContent = t("startEngagementPeriod");
  document.getElementById("t_endEngagementPeriod").textContent = t("endEngagementPeriod");
  document.getElementById("t_deleteEngagementPeriod").title = t("deleteEngagementPeriodTitle");
  document.getElementById("engagementSearch").placeholder = t("searchMember");
...
export function ssCellInfo(store, member, week) {
  ...
  if (!entry) return isExempt(member, week) ? { cls: "pill-gray", text: t("exemptLabel") } : { cls: "pill-gray", text: t("notRegistered") };
  if (!entry.group) {
    // Kontenjan (30 kişi) yüzünden seçilememiş olabilir — "hiç uğraşmadı" ile
    // "başvurdu ama yer bulamadı" ayrı görünsün diye ayrı bir etiket kullanılır.
    const applied = !!(entry.appliedSlot1 || entry.appliedSlot2 || entry.appliedSlot3);
    return { cls: "pill-gray", text: applied ? t("ssAppliedNotSelected") : t("notRegistered") };
  }
