...
const DICT = {
  tr: { appName:'EXC Paneli', tagline:'Üye · Rütbe · Güç & Kamp Seviyesi · Etkinlik Takibi', refresh:'Yenile', backToSite:'← Ana Siteye Dön',
    ...
    lblColor:'Unvan', thColor:'Unvan', thServer:'Sunucu', lblServer:'Mevcut Sunucu', lblProspectNote:'Tahmini Gidecek Lonca/Not', lblProspectScore:'Puan',
  ...
  en: { appName:'EXC Panel', tagline:'Members · Rank · Power & Camp Level · Event Tracking', refresh:'Refresh', backToSite:'← Back to Site',
    ...
    lblColor:'Title', thColor:'Title', thServer:'Server', lblServer:'Current Server', lblProspectNote:'Predicted Destination Guild/Note', lblProspectScore:'Score',
  ...
  de: { appName:'EXC Panel', tagline:'Mitglieder · Rang · Machtstufe & Basisstufe · Event-Tracking', refresh:'Aktualisieren', backToSite:'← Zur Website',
    ...
    lblColor:'Titel', thColor:'Titel', thServer:'Server', lblServer:'Aktueller Server', lblProspectNote:'Voraussichtliche Zielgilde/Notiz', lblProspectScore:'Punkte',
  ...
  es: { appName:'Panel EXC', tagline:'Miembros · Rango · Poder y Nivel de Campamento · Seguimiento de Eventos', refresh:'Actualizar', backToSite:'← Volver al Sitio',
    ...
    lblColor:'Título', thColor:'Título', thServer:'Servidor', lblServer:'Servidor actual', lblProspectNote:'Gremio de Destino Previsto/Nota', lblProspectScore:'Puntuación',
  ...
  fr: { appName:'Panneau EXC', tagline:'Membres · Rang · Puissance et Niveau de Camp · Suivi des Événements', refresh:'Actualiser', backToSite:'← Retour au Site',
    ...
    lblColor:'Titre', thColor:'Titre', thServer:'Serveur', lblServer:'Serveur actuel', lblProspectNote:'Guilde de Destination Prévue/Note', lblProspectScore:'Score',
  ...
  vi: { appName:'EXC Panel', tagline:'Thành viên · Cấp bậc · Sức mạnh & Cấp độ Trại · Theo dõi Sự kiện', refresh:'Làm mới', backToSite:'← Về Trang chủ',
    ...
    lblColor:'Danh hiệu', thColor:'Danh hiệu', thServer:'Máy chủ', lblServer:'Máy chủ Hiện tại', lblProspectNote:'Bang hội Dự kiến Đến/Ghi chú', lblProspectScore:'Điểm',
    ...
    lblMigrated:'Đã di chuyển sang máy chủ khác', migratedTag:'Đã di chuyển',
