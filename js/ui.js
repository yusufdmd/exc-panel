...
const DICT = {
  tr: { appName:'EXC Paneli', tagline:'Üye · Rütbe · Güç & Kamp Seviyesi · Etkinlik Takibi', refresh:'Yenile', backToSite:'← Ana Siteye Dön',
    ...
    aiFillBtn:'🤖 AI ile Doldur', aiFillWorking:'AI okuyor…', aiFillDone:'{n} üye için dolduruldu, kontrol edip kaydedin.', aiFillError:'AI okuma başarısız oldu.', aiFillNoMembers:'Listede üye yok.', aiFillTooMany:'En fazla {n} fotoğraf birden seçebilirsin.',
  ...
  en: { appName:'EXC Panel', tagline:'Members · Rank · Power & Camp Level · Event Tracking', refresh:'Refresh', backToSite:'← Back to Site',
    ...
    aiFillBtn:'🤖 Fill with AI', aiFillWorking:'Reading…', aiFillDone:'Filled {n} members — review and save.', aiFillError:'AI reading failed.', aiFillNoMembers:'No members in the list.', aiFillTooMany:'You can select at most {n} photos at once.',
  ...
  de: { appName:'EXC Panel', tagline:'Mitglieder · Rang · Machtstufe & Basisstufe · Event-Tracking', refresh:'Aktualisieren', backToSite:'← Zur Website',
    ...
    aiFillBtn:'🤖 Mit KI ausfüllen', aiFillWorking:'Wird gelesen…', aiFillDone:'{n} Mitglieder ausgefüllt — bitte prüfen und speichern.', aiFillError:'KI-Auslesen fehlgeschlagen.', aiFillNoMembers:'Keine Mitglieder in der Liste.', aiFillTooMany:'Du kannst höchstens {n} Fotos gleichzeitig auswählen.',
  ...
  es: { appName:'Panel EXC', tagline:'Miembros · Rango · Poder y Nivel de Campamento · Seguimiento de Eventos', refresh:'Actualizar', backToSite:'← Volver al Sitio',
    ...
    aiFillBtn:'🤖 Rellenar con IA', aiFillWorking:'Leyendo…', aiFillDone:'Se completaron {n} miembros — revisa y guarda.', aiFillError:'Error al leer con IA.', aiFillNoMembers:'No hay miembros en la lista.', aiFillTooMany:'Puedes seleccionar como máximo {n} fotos a la vez.',
  ...
  fr: { appName:'Panneau EXC', tagline:'Membres · Rang · Puissance et Niveau de Camp · Suivi des Événements', refresh:'Actualiser', backToSite:'← Retour au Site',
    ...
    aiFillBtn:'🤖 Remplir avec l\'IA', aiFillWorking:'Lecture en cours…', aiFillDone:'{n} membres remplis — vérifiez et enregistrez.', aiFillError:'Échec de la lecture par l\'IA.', aiFillNoMembers:'Aucun membre dans la liste.', aiFillTooMany:'Tu peux sélectionner au maximum {n} photos à la fois.',
  ...
  vi: { appName:'EXC Panel', tagline:'Thành viên · Cấp bậc · Sức mạnh & Cấp độ Trại · Theo dõi Sự kiện', refresh:'Làm mới', backToSite:'← Về Trang chủ',
    ...
    aiFillBtn:'🤖 Điền bằng AI', aiFillWorking:'Đang đọc…', aiFillDone:'Đã điền {n} thành viên — kiểm tra rồi lưu.', aiFillError:'AI đọc thất bại.', aiFillNoMembers:'Không có thành viên trong danh sách.', aiFillTooMany:'Bạn chỉ có thể chọn tối đa {n} ảnh cùng lúc.',
