...
create table if not exists migration_prospects (
  ...
  score       bigint, -- Unvan'ın hemen altında gösterilir; elle girilen serbest bir puan (bkz. add_migration_score.sql)
  created_at  timestamptz not null default now(),
  updated_at  timestamptz not null default now()
);
...
-- =====================================================================
-- 7.2) NEWS — ana sayfadaki "Haberler" bölümü. Herkes okuyabilir, sadece
--      admin ekleyip/düzenleyip/silebilir — SITE_LINKS ile aynı sebeple
--      genel RLS döngüsüne dahil edilmez, kendi politikaları burada.
--      Resimler Supabase Storage'daki "news-images" bucket'ında tutulur.
-- =====================================================================
